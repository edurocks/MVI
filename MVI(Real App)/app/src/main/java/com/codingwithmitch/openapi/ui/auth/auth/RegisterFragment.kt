...
class RegisterFragment : BaseAuthFragment() {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        viewModel.setRegistrationFields(RegistrationFields(input_email.text.toString(), input_password.text.toString(),
                                                            input_username.text.toString(), input_password_confirm.text.toString()))
    }
}
